    ...
    DataRegistryByPhonePage.prototype.ionViewWillLeave = function () {
        ...
        this.storage.get('id_user').then(function (id) {
            _this.apiTraveler.getData(id)
                .subscribe(function (data) {
                _this.storage.set("datos", data[0]);
            }, function (error) {
